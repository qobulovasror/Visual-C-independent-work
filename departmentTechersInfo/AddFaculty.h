...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Size = System::Drawing::Size(364, 395);
			...
			this->button2->Click += gcnew System::EventHandler(this, &AddFaculty::button2_Click);
			// 
			// button1
			// 
			...
			this->panel1->Size = System::Drawing::Size(364, 38);
			...
			this->button3->Location = System::Drawing::Point(326, 5);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(35, 28);
			this->button3->TabIndex = 0;
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &AddFaculty::button3_Click);
			// 
			// AddFaculty
			// 
			...
			this->ClientSize = System::Drawing::Size(364, 435);
